...
.venue-chip {
  padding: 10px 16px; border-radius: 22px; background: #eef4fc;
  box-shadow: var(--tj-member-lift); border: var(--tj-member-edge); display: flex; flex-direction: column; gap: 2px; cursor: pointer;
}
.venue-chip:nth-child(even) { background: #eaf5f6; }
.venue-chip.active { border: 2px solid #2a4365; background: #e8f1f9; }
.venue-chip.warn { border: 2px solid #faad14; background: #fffbe6; }
.venue-chip.full { border: 2px solid #ff4d4f; background: #fff1f0; }
.venue-chip b { font-size: 14px; }
.venue-chip .cap { font-size: 13px; color: #7a88a0; }
.venue-chip .rate { font-size: 12px; color: #2a4365; font-weight: 600; }
...
.card {
  ...
  background: #e8f4f5; box-shadow: var(--tj-member-lift); border: var(--tj-member-edge);
}
.two-cards .card:last-child { background: #eaf2fa; }
...
.field input, .field select {
  padding: 10px 12px; border: 1px solid rgba(42, 67, 101, 0.18); border-radius: 16px;
  font-size: 15px; background: rgba(255, 255, 255, 0.75);
}
.field input:focus, .field select:focus { outline: none; border-color: #2a4365; }
.hint-text { color: #5a6a82; font-size: 12px; }

.btn-primary {
  padding: 10px 20px; border: none; border-radius: 999px;
  background: #2a4365; color: #fff; font-size: 15px; font-weight: 600; cursor: pointer;
}
.btn-primary:disabled { opacity: .5; cursor: not-allowed; }

.checkout-card.is-active { border: 2px solid #2a4365; }

.btn-checkout {
  margin-top: 16px; padding: 10px 20px; border: 2px solid #cf1322; border-radius: 999px;
...
.ok-badge {
  ...
  background: #eaf5f6; color: #2a4365; font-size: 13px; font-weight: 600; margin: 0 0 12px;
}

.kv { display: grid; gap: 10px; }
.row { display: flex; justify-content: space-between; padding-bottom: 8px; border-bottom: 1px solid rgba(42, 67, 101, 0.12); }
.row:last-child { border: none; padding-bottom: 0; }
.row span { color: #7a88a0; }

.bar-bg { height: 10px; border-radius: 999px; background: rgba(255, 255, 255, 0.65); overflow: hidden; }
.bar { height: 100%; border-radius: 999px; background: #2a4365; transition: width .3s; }
