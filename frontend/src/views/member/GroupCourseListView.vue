...
.ghost-link {
  ...
  border: 1px solid #d7e0ef; color: #2a3c59; text-decoration: none; font-weight: 600;
}
.booking-message { margin-bottom: 16px; padding: 12px 16px; border-radius: 10px; font-weight: 600; }
.booking-message.success { background: #e8f7ee; color: #15803d; }
...
.product-card {
  padding: 20px; border-radius: var(--tj-radius); background: var(--tj-card-bg); box-shadow: var(--tj-shadow);
  display: flex; flex-direction: column; gap: 10px;
}
.price { color: #4d77ff; font-size: 22px; }
.meta { color: #72819a; }
.booking-button, .link-btn {
  margin-top: auto; padding: 10px 14px; border: none; border-radius: 999px;
  background: #4d77ff; color: #fff; font-weight: 600; cursor: pointer; text-align: center; text-decoration: none;
}
