...
import { formatBeijingDateTime, parseBeijingDate } from '@/utils/datetime'
...
function formatTime(value: string) {
  return parseBeijingDate(value).toLocaleTimeString('zh-CN', {
  ...
  <div class="coach-home">
    ...
    <template v-else>
      ...
      <section class="dashboard-grid">
        <article class="dashboard-card panel-tone-blue">
          <div class="card-head">
            <div>
          ...
          <div v-else class="session-list">
            <article v-for="session in todaySchedules" :key="session.scheduleId" class="session-item list-item">
        ...
        <article class="dashboard-card panel-tone-green">
          <div class="card-head">
            <div>
          ...
          <div v-else class="pt-list">
            <article v-for="item in pendingPt" :key="item.ptBookingId" class="pt-item list-item">
